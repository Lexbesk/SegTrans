...
def get_cross_image_attention(args):
    ...
    app_segmentation_output_dir = segmentation_output_dir / "appearance_image"
    ...
    cross_maps[4096], labels1 = create_cross_mask(str_masks, app_masks, 64, classnames, args.device)
    cross_maps[1024], labels2 = create_cross_mask(str_masks, app_masks, 32, classnames, args.device)
...
def main(args):
    ...
    assert (structure_image is not None) and (appearance_image is not None)
